...
<div class="w-11/12 mx-auto text-left md:w-10/12 lg:w-8/12">
  ...
  <div class="pt-5 text-gray-900 paragraphs">
    Yes, this website was built mostly just to rant about Quibi. If you haven't
    heard what Quibi is, it's a company that managed to raise 1.8 BILLION
    dollars before launching anything. They just launched on April 6, 2020 and,
    well... I was mad enough to make an entire website explaining how dumb it is
    <img src="/crazy.png" alt="Crazy Emoji" class="inline w-6 " />
    .
  </div>
  <div class="pt-5 text-gray-900 paragraphs">
    Quibi is essentially trying to be the Netflix of mobile. But Netflix already
    is the Netflix of mobile... Quibi was started by two old(er) billionaires,
    so they definitely know what the kids are into these days. It's definitely
    giving me an Apple TV+ vibe: Mostly rich, mostly older people saying, we
    know what people want! Let's throw x amount of dollars at it, and see what
    comes out the other end. In Apple TV+'s case, they managed to produce a
    small number of rather lame shows. But they wanted to make it seem like a
    hit, so they have (and still are) giving out a free ONE YEAR subscription if
    you buy any Apple device. Even with that they've only managed 33 million
    subscribers. That's fine for Apple though, because they have $200+ BILLION
    just sitting in their piggy bank. They can bankroll as many sub-par TV shows
    as they want for years to come, and not fall into financial peril.
  </div>
  <div class="pt-5 text-gray-900 paragraphs">
  ...
  <div class="pt-5 text-gray-900 paragraphs">
    ...
    don't think anyone will want to touch them after initial subscriber numbers
    come out. Below is an interactive chart where you can play with different
...
<div class="w-11/12 mx-auto text-left md:w-10/12 lg:w-8/12">
  ...
  <div class="pt-5 text-gray-900 paragraphs">
    ...
    souls that rotate-lock their phones, they'll never even know they could have
    enjoyed all their Quibis without so many insane face close-ups!
  </div>
  <div class="pt-5 text-gray-900 paragraphs">
    The second biggest issue:
    <b>there's no casting!</b>
    It would make more sense if everything was actually locked into portrait
    mode, because then casting wouldn't be much of an upgrade. But they actually
    have all the videos in widescreen! The entire world is on lock down, with
    access to very large, very capable televisions, but no, this is premium
    content meant to be watched only on your smallest of screens! Hopefully
    they'll come to their senses and fix this ASAP. It would probably take a day
    to implement, and there's no excuse for a video only app in 2020 not to have
    casting.
  </div>
  <div class="pt-5 text-gray-900 paragraphs">
    ...
    <u>
      The only reason people pay for streaming is if there's something to watch!
    </u>
    Without content people will cancel their subscription faster than Yahoo goes
    bankrupt. Now it has been shown that killer shows can increase subscribers,
    but if there's nothing else they want to watch after that, people just
    leave. Imagine Disney+ only had the Mandalorian and Cats. After you've
    watched the Mandalorian twice, you're not going to keep paying every month
    to see the Cats banner on your screen. Lucky for Disney they've got a
    bajillion movies on there of every genre. Same goes for Netflix. Hulu
    focuses on TV shows and some movies, and are also owned by Disney, so their
    back catalog is huge. Apple TV+ is the only one without a wide depth of
    shows and we've already discussed how it doesn't really matter because Apple
  ...
  <div class="pt-5 text-gray-900 paragraphs">
    ...
    part of the plan, to prevent people from watching literally everything they
    have to offer in 2 days...
  </div>
  <div
    class="text-3xl text-center underline bold md:pt-10 "
    style="font-family: 'Josefin Sans', sans-serif; font-weight:700; ">
  ...
  <div class="pt-5 text-gray-900 paragraphs">
    The most hilarious thing about all of this is that Quibi is offering people
    3 months free right now. While they're in quarantine, with nowhere else to
    go. So if people do like a show, they're FOR SURE finish it during their
    free trial. And since there's absolutely no back catalog, why would you
    stick around? Did they not notice Netflix and Disney spending their millions
    on securing hundreds of shows to plump out their back catalog? Why did Quibi
    ever get this much money? These Venture Capitalist firms need to calm down.
    And so do I! That's it for now. Go do something nice for someone else and
    have a great day/month/2020!
  </div>
